    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div class="col-xs-6 col-lg-4">
              <h2>Логарифм</h2>           
               <form method="POST" action="">
                    ...
                    <input name="logarifm" type="hidden" value="1"/>
                    <button type="submit" class="btn btn-default">Логарифм</button>
                </form>
            </div><!--/.col-xs-6.col-lg-4--> 
	    ...
	    <div class="col-xs-6 col-lg-4">              
              ...
              <form method="POST" action="">
                    <div class="form-group">
                        <label for="additionN1">Число</label>
                        <input type="text" name="num1" class="form-control" id="additionN1" placeholder="0">
                    </div>
                    <div class="form-group">
                        <label for="additionN2">Корень степени</label>
                        <input type="text" name="num2" class="form-control" id="additionN2" placeholder="0" value="2">
                    </div>
            ...
            <div class="col-xs-6 col-lg-4">
              ...
              <form method="POST" action="">
                    ...
                    <input name="lcm" type="hidden" value="1"/>
                    <button type="submit" class="btn btn-default">НОК</button>
                </form>
            </div><!--/.col-xs-6.col-lg-4-->      
